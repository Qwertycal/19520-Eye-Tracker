...
def screenSetup():
    ...
    canvas.create_oval(x2, y1, (x2 + dotSize), (y1 + dotSize), outline = "gray", fill = "gray") #top middle
    canvas.create_oval(x3, y1, (x3 + dotSize), (y1 + dotSize), outline = "gray", fill = "gray") #top right
    ...
    canvas.create_oval(x3, y2, (x3 + dotSize), (y2 + dotSize), outline = "gray", fill = "gray") #middle third left
    
    canvas.create_oval(x1, y3, (x1 + dotSize), (y3 + dotSize), outline = "gray", fill = "gray") #bottom left
    canvas.create_oval(x2, y3, (x2 + dotSize), (y3 + dotSize), outline = "gray", fill = "gray") #bottom middle
    canvas.create_oval(x3, y3, (x3 + dotSize), (y3 + dotSize), outline = "gray", fill = "gray") #botton right
...
def moveMouse():
    ...
    dur = 0.4
    coords = [(screenLocX1, screenLocY1), (screenLocX2, screenLocY1), (screenLocX3, screenLocY1), (screenLocX1, screenLocY2),
              (screenLocX2, screenLocY2), (screenLocX3, screenLocY2), (screenLocX1, screenLocY3), (screenLocX2, screenLocY3),
              (screenLocX3, screenLocY3)]
...
class FullScreenApp(object):
    def __init__(self, master, **kwargs):
        ...
        master.bind("<space>", submit)
        master.bind("q",lambda e: root.quit())
