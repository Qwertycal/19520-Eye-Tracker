...
def screenSetup():
    ...
    canvas.create_oval(x2, y1, (x2 + dotSize), (y1 + dotSize), outline = "gray", fill = "gray") #second top left
    canvas.create_oval(x4, y1, (x4 + dotSize), (y1 + dotSize), outline = "gray", fill = "gray") #third top left
    ...
    canvas.create_oval(x3, y2, (x3 + dotSize), (y2 + dotSize), outline = "gray", fill = "gray") #middle middle
    canvas.create_oval(x5, y2, (x5 + dotSize), (y2 + dotSize), outline = "gray", fill = "gray") #middle right


    canvas.create_oval(x1, y3, (x1 + dotSize), (y3 + dotSize), outline = "gray", fill = "gray") #top left
    canvas.create_oval(x2, y3, (x2 + dotSize), (y3 + dotSize), outline = "gray", fill = "gray") #second top left
    canvas.create_oval(x4, y3, (x4 + dotSize), (y3 + dotSize), outline = "gray", fill = "gray") #third top left
    canvas.create_oval(x5, y3, (x5 + dotSize), (y3 + dotSize), outline = "gray", fill = "gray") #top right
...
def moveMouse():
    ...
    dur = 0.4
    coords = [(screenLocX1, screenLocY1), (screenLocX2, screenLocY1), (screenLocX4, screenLocY1), (screenLocX5, screenLocY1),
              (screenLocX1, screenLocY2),(screenLocX3, screenLocY2), (screenLocX5, screenLocY2),
              (screenLocX1, screenLocY3),(screenLocX2, screenLocY3), (screenLocX4, screenLocY3), (screenLocX5, screenLocY3)]
