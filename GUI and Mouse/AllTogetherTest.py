...
while var == 1:
    spaceCount = 0
    cursorClick = 200 #alters how long the user must look at a point before a click
    maxMovement = 10 #alters the area the user must look at to invoke a click
    #maxClickMovement = 200
    cursorDoubleClick = 400
    doubleCount = 0
